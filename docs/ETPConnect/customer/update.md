...
{
  ActionInfo: {
    ActionId: { DataType: 'String', Mandatory: 'M', DataWith: 10, HardCode: 'CUSTUPD_R' },
  },
  CompanyInfo: {
  ...
  CustDetails: {
    CustomerInfo: {
      CustomerID: { DataType: 'String', Mandatory: 'O', DataWith: 15, HrField: 'etp_id', Description: 'ETP ID' },
